...
class BaseController extends \yii\web\Controller
{
	...
	public function successMessage($text = false) 
	{
		$text = $text ? $text : 'Действие выполнено успешно';
		return $this->setMessage($text);
	}

	public function errorMessage($text = false)
	{
		$text = $text ? $text : 'При выполнении произошла ошибка';
		return $this->setMessage($text, 'error');
	}
