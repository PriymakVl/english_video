...
use Yii;
use app\modules\category\models\{Category, CategorySearch};
...
class CategoryController extends BaseController
{
    ...
    public function actionParent($parent_id = PARENT_ID_CORE)
    {
        ...
        return $this->render('parent', compact('parent', 'categories'));
    }
